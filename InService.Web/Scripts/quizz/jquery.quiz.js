        ...
        base.methods = {
            ...
            setup: function () {
                ...
                $.each(questions, function (i, question) {
                    ...
                    quizHtml += '<div class="card shadow">';
                    quizHtml += '<div class="card-header">';
                    quizHtml += '<div class="form-inline">';
                    quizHtml += '<span class="badge badge-pill">Question number</span>';
                    quizHtml += '<small class="ml-auto">' + question.score + '</small>';
                    quizHtml += '</div>';
                    quizHtml += '</div>';
                    quizHtml += '<div class="card-body">';
                    quizHtml += '<p class="question">' + question.q + '</p>';
                    quizHtml += '<table class="table table-sm table-active table-hover">';
                    quizHtml += '<thead>';
                    quizHtml += '<tr>';
                    quizHtml += '<th>Suggestions</th>';
                    quizHtml += '</tr>';
                    quizHtml += '</thead>';
                    quizHtml += '<tbody class="answers">';
                    $.each(question.options, function (index, answer) {
                        quizHtml += '<tr >';
                        quizHtml += '<td>';
                        quizHtml += '<a href="#" data-index="' + index + '">' + answer + '</a>';
                        quizHtml += '</td>';
                        quizHtml += ' </tr>';
                    });
                    quizHtml += '</tbody>';
